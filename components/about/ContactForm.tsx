...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        className="bg-burnt text-white font-sans text-xs tracking-wider uppercase py-3 rounded hover:bg-burnt/85 transition-colors flex items-center justify-center gap-2"
      >
