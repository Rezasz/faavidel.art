...
async function main() {
  ...
  await seed('homepage.json', {
    ...
    featuredArtworkSlugs: ['ocean-reverie', 'ember-study-ii', 'night-bloom', 'between-tides', 'fog-study-morning', 'deep-field'],
  ...
  const artworks = [
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-ocean1/900/700',
      year: 2024,
      order: 1,
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-ember2/900/700',
      year: 2024,
      order: 2,
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-bloom3/900/700',
      year: 2024,
      order: 3,
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-drift4/900/700',
      year: 2023,
      order: 4,
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-carto5/900/700',
      year: 2023,
      order: 5,
    ...
    },
    {
      ...
      imageUrl: 'https://picsum.photos/seed/art-salt6/900/700',
      year: 2023,
      order: 6,
    ...
    },
    {
      slug: 'between-tides',
      title: 'Between Tides',
      description: 'Acrylic on canvas. The painting captures the liminal moment when the tide withdraws — the sand still dark, the air still salt. 90×120cm.',
      tags: ['painting', 'ocean', 'acrylic'],
      imageUrl: 'https://picsum.photos/seed/art-tides7/900/700',
      year: 2024,
      order: 7,
      createdAt: '2024-05-22T10:00:00Z',
    },
    {
      slug: 'fog-study-morning',
      title: 'Fog Study: Morning',
      description: 'Gouache on paper. A recurring series of fog studies — this one caught the exact color of early light filtered through dense coastal fog.',
      tags: ['gouache', 'landscape', 'study'],
      imageUrl: 'https://picsum.photos/seed/art-fog8/900/700',
      year: 2024,
      order: 8,
    ...
    },
    {
      slug: 'red-room',
      title: 'Red Room',
      description: 'Oil on linen. An interior: a chair, a window, late afternoon light flooding the floor. The red came last and changed everything.',
      tags: ['oil', 'interior', 'painting'],
      imageUrl: 'https://picsum.photos/seed/art-red9/900/700',
      year: 2023,
      order: 9,
    ...
    },
    {
      slug: 'threshold',
      title: 'Threshold',
      description: 'Large-scale abstract work in charcoal and white chalk on black ground. The mark made just before stopping. 150×200cm.',
      tags: ['charcoal', 'abstract', 'large scale'],
      imageUrl: 'https://picsum.photos/seed/art-thresh10/900/700',
      year: 2023,
      order: 10,
      createdAt: '2023-07-30T10:00:00Z',
    },
    {
      slug: 'tide-pool-atlas',
      title: 'Tide Pool Atlas',
      description: 'Watercolor and ink. A series of close observations of tide pool organisms — rendered as if for a natural history archive that does not exist.',
      tags: ['watercolor', 'ink', 'illustration'],
      imageUrl: 'https://picsum.photos/seed/art-tide11/900/700',
      year: 2022,
      order: 11,
      createdAt: '2022-10-05T10:00:00Z',
    },
    {
      slug: 'deep-field',
      title: 'Deep Field',
      description: 'Inspired by the Hubble deep field images. Tiny marks in silver and white on black — a meditation on scale, time, and the absurdity of presence.',
      tags: ['painting', 'abstract', 'silver'],
      imageUrl: 'https://picsum.photos/seed/art-deep12/900/700',
      year: 2022,
      order: 12,
  ...
  const products = [
    {
      ...
      price: 4800,
      images: [
        'https://picsum.photos/seed/shop-p1a/800/1000',
        'https://picsum.photos/seed/shop-p1b/800/1000',
      ],
      stock: 12,
    ...
    },
    {
      ...
      price: 5500,
      images: [
        'https://picsum.photos/seed/shop-p2a/800/1000',
        'https://picsum.photos/seed/shop-p2b/800/1000',
      ],
      stock: 8,
      status: 'active' as const,
      createdAt: '2024-09-15T10:00:00Z',
    },
    {
      ...
      price: 4200,
      images: [
        'https://picsum.photos/seed/shop-p3a/800/1000',
        'https://picsum.photos/seed/shop-p3b/800/1000',
      ],
      stock: 15,
      status: 'active' as const,
    ...
    },
    {
      ...
      price: 2800,
      images: [
        'https://picsum.photos/seed/shop-zine1/800/600',
        'https://picsum.photos/seed/shop-zine2/800/600',
      ],
      stock: 40,
      status: 'active' as const,
    ...
    },
    {
      ...
      price: 5200,
      images: [
        'https://picsum.photos/seed/shop-p4a/800/1000',
        'https://picsum.photos/seed/shop-p4b/800/1000',
      ],
      stock: 6,
      status: 'active' as const,
